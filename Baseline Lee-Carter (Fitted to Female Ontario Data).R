...
#Input CSV
mortality_file <- file.path("C:","Users","alexp","OneDrive","Desktop",
"Climate Finance (SAS-2)","R-Projects","Ontario models",
"1991-2023 - Female Mortality Count age 20-89.csv")

exposure_file <- file.path("C:","Users","alexp","OneDrive","Desktop",
"Climate Finance (SAS-2)","R-Projects","Ontario models",
"1991-2023 - Female Exposure Count 20-89.csv")
